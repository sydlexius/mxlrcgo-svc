...
Intel system is disabled. To activate:
  ...
  node .opencode/get-shit-done/bin/gsd-tools.cjs config-set intel.enabled true
...
```bash
node .opencode/get-shit-done/bin/gsd-tools.cjs intel query <term>
```
...
```bash
node .opencode/get-shit-done/bin/gsd-tools.cjs intel status
```
...
```bash
node .opencode/get-shit-done/bin/gsd-tools.cjs intel diff
```
...
Project root: ${CWD}
gsd-tools path: .opencode/get-shit-done/bin/gsd-tools.cjs
