...
var settingsLabels = map[string]string{
	...
	"instrumental_detector.vocal_max_confidence":    "Most vocals allowed before not instrumental (0-1)",
	"instrumental_detector.spread_samples":          "Samples taken across the track",
