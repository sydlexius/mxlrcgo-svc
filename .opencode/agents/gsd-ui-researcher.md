...
Use template from `/Users/jesse/Developer/mxlrc-go/.opencode/get-shit-done/templates/UI-SPEC.md`.
...
Read template: `/Users/jesse/Developer/mxlrc-go/.opencode/get-shit-done/templates/UI-SPEC.md`
...
```bash
node "/Users/jesse/Developer/mxlrc-go/.opencode/get-shit-done/bin/gsd-tools.cjs" commit "docs($PHASE): UI design contract" --files "$PHASE_DIR/$PADDED_PHASE-UI-SPEC.md"
```
