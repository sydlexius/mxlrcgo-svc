...
// minimalID3v2 is a minimal ID3v2.3 tag with TIT2 ("Test Title") and TYPE1
// ("Test Artist") frames. dhowden/tag parses this without error.
// Generated by encoding TIT2 + TYPE1 frames into a syncsafe-size ID3v2.3 header.
var minimalID3v2 = []byte{
	...
	0x54, 0x50, 0x45, 0x31, 0x00, 0x00, 0x00, 0x0c, 0x00, 0x00, // TYPE1 frame header (size=12)
