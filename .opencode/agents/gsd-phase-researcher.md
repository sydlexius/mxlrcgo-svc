...
@.opencode/get-shit-done/references/thinking-models-research.md
...
## Step 7: Commit Research (if commit_docs is true)
...
- [ ] RESEARCH.md committed to git (only if commit_docs is true)
