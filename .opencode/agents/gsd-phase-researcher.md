...
```bash
node "/Users/jesse/Developer/mxlrc-go/.opencode/get-shit-done/bin/gsd-tools.cjs" websearch "your query" --limit 10
```
...
@/Users/jesse/Developer/mxlrc-go/.opencode/get-shit-done/references/thinking-models-research.md
...
```bash
INIT=$(node "/Users/jesse/Developer/mxlrc-go/.opencode/get-shit-done/bin/gsd-tools.cjs" init phase-op "${PHASE}")
...
```bash
node "/Users/jesse/Developer/mxlrc-go/.opencode/get-shit-done/bin/gsd-tools.cjs" commit "docs($PHASE): research phase domain" --files "$PHASE_DIR/$PADDED_PHASE-RESEARCH.md"
```
