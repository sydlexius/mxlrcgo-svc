...
<reference>
@/Users/jesse/Developer/mxlrc-go/.opencode/get-shit-done/references/user-profiling.md
...
Read the user-profiling reference document at `/Users/jesse/Developer/mxlrc-go/.opencode/get-shit-done/references/user-profiling.md` to load:
